...
module.exports.sendEmailAddNew = (fullName, role, password, link) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        <div class="full-email">
            ...
            <div>
                <div>
                    Welcome to BookStore! From now on, you become a member with the role of ${role}. We send you a password to log in to the system, absolutely do not share this password with anyone.
                </div>
                <div class="btn-verify">
                ...
                <div >Please change your password as soon as you successfully log in to maximize the security of your account!</div>
                <div>
                    Thank you.
                </div>
                <div>
