window.addEventListener('DOMContentLoaded', event => {
    ...
    if (saleTable) {
        const saleDataTable = new simpleDatatables.DataTable(saleTable, {
            searchable: false,
            paging: false,
        });
...
function updateTablePagination(item, clickPageNum){
    ...
    tableData.html(tableDataTemplate({saleReceipts}));
    // console.log("tableData: ",tableData.html());
    console.log("tableData : ", tableDataTemplate({saleReceipts}));
...
function initEvent(){
    $("#pagination").on('click', '.page-link', async function(e) {
        ...
        if (tableDataAndPagination){
            saleReceipts = tableDataAndPagination.saleReceipts;
    ...
    $("#exportBtn").click(async function(){
        ...
        const hrefExportData = '/api/sale/export?' + exportUrlParams.toString();
...
async function getTableDataAndPagination(urlApi){
    ...
    await $.ajax({
        ...
        success: function (data){
            ...
            console.log("data.saleReceipts: ", data.saleReceipts);

            pagination = data.pagination;
            saleReceipts = data.saleReceipts;
        }
    })

    console.log("pagination: ", pagination);
    console.log("saleReceipts: ", saleReceipts);

    if (pagination && saleReceipts){
        console.log("succces");
        return {pagination, saleReceipts};
    }
